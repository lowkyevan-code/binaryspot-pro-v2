    ...
    <main className="min-h-screen bg-[#070a10] text-slate-100">
      <div className="border-b border-slate-800 bg-[#070b11]">
        <div className="max-w-[1600px] mx-auto px-3 sm:px-4 py-2">
              ...
              {isAuthorized ? (
                <>
                  <button
                    ...
                    className="hidden sm:inline-flex rounded-xl border border-slate-800 bg-slate-900 px-3 py-2 text-[9px] font-black text-slate-400"
                  >
                    {accountId || 'ACCOUNT'}
                  </button>
          ...
          <div className="sm:hidden mt-2 flex items-center justify-between gap-2">
            ...
            >
              {accountType ? accountType.toUpperCase() : 'OFFLINE'}
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-[1600px] mx-auto lg:flex lg:min-h-[calc(100vh-132px)]">
        ...
        <div className="min-w-0 flex-1">
          <section className="px-3 sm:px-5 lg:px-7 py-5 sm:py-7">
        {authError && (
          <Alert>
            ⚠️ {authError}
          </Alert>
