    ...
    <main className="min-h-screen bg-[#070a10] text-slate-100">
      ...
      {isAccountSwitcherOpen && (
        <div className="fixed inset-0 z-[70] flex items-end sm:items-center justify-center p-0 sm:p-4">
          ...
          <div className="relative w-full sm:max-w-lg rounded-t-3xl sm:rounded-3xl border border-slate-800 bg-[#0a0f17] shadow-2xl max-h-[85vh] overflow-y-auto">
            <div className="sticky top-0 z-10 flex items-start justify-between gap-4 border-b border-slate-800 bg-[#0a0f17]/95 backdrop-blur p-5">
              <div>
                ...
                <p className="mt-2 text-xs leading-5 text-slate-500">
                  Choose the Deriv Options account BinarySpot should connect to.
                </p>
              </div>
              ...
              {Array.isArray(accounts) && accounts.length > 0 ? (
                    ...
                    >
                      <div className="flex items-start justify-between gap-3">
                        <div className="min-w-0">
                          ...
                          <p className="mt-3 text-sm font-black break-all text-slate-100">
                            {optionId}
                          </p>
                        ...
                        <div className="text-right">
                          ...
                          <p className="mt-1 text-sm font-mono font-black text-slate-200">
                            {optionBalance !== undefined &&
                            optionBalance !== null
                              ? Number(optionBalance).toLocaleString(
                                  'en-US',
                                  {
                      ...
                      <div className="mt-4 flex items-center justify-between gap-3 border-t border-slate-800 pt-3">
                        <p className="text-[10px] text-slate-600">
                          {selected
                            ...
                            : `Switch to ${optionType.toLowerCase()} account`}
                        </p>

                        {!selected && !switchBlocked && (
                ...
                <div className="rounded-2xl border border-dashed border-slate-800 bg-[#080c12] p-7 text-center">
                  ...
                  <p className="mt-2 text-xs leading-5 text-slate-600">
                    Reconnect Deriv to reload the accounts available to this OAuth session.
                  </p>
                </div>
              )}

              <div className="rounded-2xl border border-rose-500/15 bg-rose-500/5 p-4">
                <p className="text-[10px] uppercase tracking-[0.16em] font-black text-rose-300">
                  Real-money protection
                </p>
                <p className="mt-2 text-xs leading-5 text-slate-500">
                  A real account can be selected for account viewing and connection status, but BinarySpot real-money contract purchases remain blocked until that feature is separately enabled.
                </p>
              </div>
