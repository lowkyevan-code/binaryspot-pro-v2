    ...
    <main className="min-h-screen bg-[#070a10] text-slate-100">
      ...
      <div className="max-w-[1600px] mx-auto lg:flex lg:min-h-[calc(100vh-132px)]">
        ...
        <div className="min-w-0 flex-1">
          <div className="lg:hidden sticky top-0 z-20 border-b border-slate-800 bg-[#0a0f17]/95 backdrop-blur">
          ...
          <section className="px-4 sm:px-5 lg:px-7 py-7">
        {authError && (
          <Alert>
            ⚠️ {authError}
          </Alert>
        ...
        {activeTab ===
          ...
          <div className="space-y-6">
            <div className="grid xl:grid-cols-[1.45fr_0.55fr] gap-5">
              <div className="rounded-3xl border border-slate-800 bg-gradient-to-br from-[#111a2a] via-[#0c121d] to-[#080c12] p-6 sm:p-8 lg:p-10 overflow-hidden relative">
                ...
                <div className="relative">
                  ...
                  <h1 className="mt-5 max-w-4xl text-3xl sm:text-4xl lg:text-5xl font-black leading-[1.05]">
                    Everything you need to monitor,
                    analyze and trade from one workspace.
                  </h1>

                  <p className="mt-5 max-w-3xl text-sm sm:text-base text-slate-400 leading-7">
        ...
        {activeTab ===
          ...
          <div className="space-y-5">
            <div className="flex flex-wrap items-end justify-between gap-4">
              <div>
                <p className="text-xs uppercase tracking-[0.22em] font-black text-emerald-500">
                  Market Workspace
                </p>
                ...
                <p className="mt-2 text-sm text-slate-500">
                  Live BinarySpot market view for {symbol}.
                </p>
              </div>

              <div className="flex items-center gap-2">
                <span className="rounded-xl border border-slate-800 bg-slate-900 px-3 py-2 text-xs font-mono text-slate-400">
                  {symbol}
                </span>

                <span className="rounded-xl border border-emerald-500/30 bg-emerald-500/10 px-3 py-2 text-xs font-black text-emerald-400">
                  {displayQuote}
                </span>
              </div>
            </div>
            ...
            <Panel>
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                  ...
                  <p className="mt-1 text-xs text-slate-500">
                    Visualized from the newest available tick digits. A full price-chart engine can be connected here next without changing the trading core.
                  </p>
                </div>
              ...
              <div className="mt-5 h-[360px] rounded-2xl border border-slate-800 bg-[#06090e] p-4 overflow-hidden relative">
                <div className="absolute inset-0 opacity-50 bg-[linear-gradient(to_right,#1e293b_1px,transparent_1px),linear-gradient(to_bottom,#1e293b_1px,transparent_1px)] bg-[size:52px_52px]" />
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-4">
                ...
                <MiniMetric
                  label="Sample"
                  value={`${digitHistory.length} ticks`}
                />
        ...
        {activeTab ===
          ...
          <div className="space-y-5">
            <div>
              <p className="text-xs uppercase tracking-[0.22em] font-black text-cyan-400">
                Trading Terminal
              </p>
              ...
              <p className="mt-2 text-sm text-slate-500">
                Request and review a Deriv proposal before manually buying a demo contract.
              </p>
            </div>
              ...
              <Panel>
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-slate-500">
                      Uses the same validated settings and proposal freshness protection already built into BinarySpot.
                    </p>
                  </div>
                ...
                <div className="grid sm:grid-cols-2 gap-4 mt-5">
                  ...
                  <Field label="Strategy / Contract Logic">
                    <select
                      value={
                        strategy
                      }
                ...
                <div className="grid sm:grid-cols-2 gap-3 mt-6">
                  <button
                    ...
                    className="py-4 rounded-xl bg-cyan-500 disabled:opacity-40 text-black font-black transition"
                  >
                    {proposalLoading
                      ? 'GETTING PROPOSAL...'
                      : 'GET LIVE PROPOSAL'}
                  ...
                  <button
                    ...
                    className="py-4 rounded-xl bg-emerald-500 disabled:opacity-40 text-black font-black transition"
                  >
                    {buyLoading
                      ? 'BUYING...'
                      : 'BUY DEMO CONTRACT'}
              ...
              <Panel>
                ...
                {proposalData ? (
                  ...
                  <div className="mt-6 rounded-2xl border border-dashed border-slate-800 bg-[#080b11] p-8 text-center">
                    ...
                    <p className="mt-2 text-xs text-slate-600">
                      Configure the contract and request a live proposal first.
                    </p>
                  </div>
                )}
              </Panel>
