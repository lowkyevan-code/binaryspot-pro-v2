                ...
                <div className="mx-auto max-w-3xl space-y-5">
                    ...
                    <div className="space-y-2 bg-[#0757b9] px-3 pb-4">
                          ...
                          <div className="flex flex-1 flex-wrap items-center gap-2">
                            <select
                              ...
                              onChange={(event) => {
                                ...
                                setBuilderContractType(
                                  contractGroups[nextTradeType]?.[0]?.contract_type || ''
                                );
                              }}
                              disabled={
                                isAutoBotRunning ||
                            ...
                            <select
                              ...
                              onChange={(event) =>
                                setBuilderContractType(event.target.value)
                              }
                              disabled={
                                isAutoBotRunning ||
                                isContractOpen ||
                                pendingBuyStatus.blocking ||
                                builderContracts.length === 0
                              }
                              className="rounded-full bg-[#0d0d0d] px-4 py-2 text-xs font-bold text-white outline-none"
                            >
                      ...
                      <div className="rounded-lg bg-[#e8e8e8] p-3 text-[#3b3b3b]">
                        <div className="flex items-center justify-between gap-3">
                          ...
                          <span className="rounded-md bg-[#111] px-3 py-1.5 text-[10px] font-black text-white">
                            SAFETY ENGINE
                          </span>
                        </div>
                      </div>
                  ...
                  >
                    ...
                    <p className="mt-1 text-xs font-black text-slate-200">
                      {contractsStatus !== 'ready'
                        ? 'Checking the selected market...'
                        : !strategyContractSupported
                        ? `${strategyExecutionContract} is not supported on this market.`
                        : !selectedContractMatchesStrategy
                        ? `Selected ${activeBuilderContractType} differs from the strategy execution ${strategyExecutionContract}.`
                        : 'Selected market and strategy are compatible.'}
                    </p>
                  </div>
                </div>
