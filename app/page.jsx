  ...
  return (
    <main className="min-h-screen bg-[#070a10] text-slate-100">
      ...
      <div className="max-w-[1600px] mx-auto lg:flex lg:min-h-[calc(100vh-132px)]">
        ...
        {activeTab ===
          'bots' && (
          <div className="-mx-3 sm:-mx-5 lg:-mx-6 -mt-3 sm:-mt-5">
            <div className="min-h-[calc(100vh-120px)] bg-[#050607] text-white">
              <div className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-[#17335c] bg-[#071b38] px-4">
                <div className="flex items-center gap-3">
                  <button
                    type="button"
                    onClick={() => setIsMobileMenuOpen(true)}
                    className="flex h-10 w-10 items-center justify-center text-2xl text-slate-200"
                  >
                    ☰
                  </button>
                ...
                >
                  <span className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-200 text-lg font-black text-slate-700">
                    Đ
                  </span>
                  <div className="text-left">
                    <p className="text-lg font-black text-[#09b6ad]">
              ...
              <div className="grid grid-cols-3 border-b border-[#244b83] bg-[#0c356e]">
                <button
                  type="button"
                  onClick={() => setActiveTab('dashboard')}
                  className="flex items-center justify-center gap-2 border-r border-[#244b83] px-2 py-4 text-sm sm:text-lg font-black"
                >
                  <span className="text-2xl text-[#ff6e4b]">⌂</span>
                  <span>Dashboard</span>
                </button>

                <button
                  type="button"
                  className="flex items-center justify-center gap-2 border-r border-[#244b83] bg-[#21489b] px-2 py-4 text-sm sm:text-lg font-black"
                >
                  <span className="text-2xl text-[#ff6e4b]">▣</span>
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-2 py-4 text-sm sm:text-lg font-black"
                >
                  <span className="text-2xl text-[#ff6e4b]">◫</span>
              ...
              <div className="relative flex min-h-[760px]">
                <aside className="hidden sm:flex w-16 shrink-0 flex-col items-center gap-7 border-r border-[#17335c] bg-[#071a33] py-7 text-2xl text-slate-200">
                  <span>↻</span>
                  <span>▱</span>
                  <span>☷</span>
                  <span className="h-px w-8 bg-[#245181]" />
                  <span>↶</span>
                  <span>↻</span>
                  <span className="h-px w-8 bg-[#245181]" />
                  <span>⌕</span>
                ...
                <main className="min-w-0 flex-1 px-3 py-7 sm:px-6">
                  <div className="mx-auto max-w-[760px]">
                    <button
                      type="button"
                      className="mb-5 bg-[#075dc6] px-7 py-4 text-xl sm:text-2xl font-black shadow-lg"
                    >
                      Quick strategy
                    </button>

                    <section className="overflow-hidden bg-[#075ac1] shadow-xl">
                      <div className="px-4 py-3 text-lg sm:text-xl font-medium">
                        ▣ 1. Trade parameters
                      </div>

                      <div className="space-y-1 px-3 pb-4">
                        <div className="bg-[#e8e8e8] px-3 py-2.5 text-[#454545]">
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            <select
                              ...
                              disabled={isAutoBotRunning || isContractOpen || pendingBuyStatus.blocking}
                              className="min-w-[180px] flex-1 rounded-full bg-black px-4 py-2 text-xs font-bold text-white outline-none"
                            >
                              {Object.entries(groupedMarkets).map(([group, items]) => (
                          ...
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            <select
                              ...
                              onChange={(event) => {
                                ...
                                const nextContract = contractGroups[nextTradeType]?.[0]?.contract_type || '';
                                setBuilderTradeType(nextTradeType);
                                setBuilderContractType(nextContract);
                                setBuilderContractMode('AUTO');
                                if (nativeStrategies.includes(nextContract)) {
                                  selectStrategy(nextContract);
                                }
                              }}
                              disabled={isAutoBotRunning || isContractOpen || pendingBuyStatus.blocking || contractsStatus !== 'ready'}
                              className="rounded-full bg-black px-4 py-2 text-xs font-bold text-white outline-none"
                            >
                            ...
                            <select
                              ...
                              onChange={(event) => {
                                const nextContract = event.target.value;
                                setBuilderContractType(nextContract);
                                setBuilderContractMode(nextContract);
                                if (nativeStrategies.includes(nextContract)) {
                                  selectStrategy(nextContract);
                                }
                              }}
                              disabled={isAutoBotRunning || isContractOpen || pendingBuyStatus.blocking || uniqueBuilderContracts.length === 0}
                              className="rounded-full bg-black px-4 py-2 text-xs font-bold text-white outline-none"
                            >
                              {uniqueBuilderContracts.map((contract) => (
                                <option key={contract.contract_type} value={contract.contract_type}>
                          ...
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            <select
                              ...
                              onChange={(event) => {
                                ...
                                setBuilderContractMode(mode);
                                if (mode !== 'AUTO' && mode !== 'BOTH') {
                                  setBuilderContractType(mode);
                                  if (nativeStrategies.includes(mode)) selectStrategy(mode);
                                }
                              }}
                            ...
                            >
                              ...
                              {builderCanUseBoth && <option value="BOTH">Both</option>}
                              {builderContractChoices.map((choice) => (
                        ...
                        <div className="bg-[#e8e8e8] px-3 py-2.5 text-[#454545]">
                          <div className="flex flex-wrap items-center gap-2">
                            <span className="text-sm">Default Candle Interval:</span>
                            <select
                              value={builderCandleInterval}
                              onChange={(event) => setBuilderCandleInterval(event.target.value)}
                              disabled={isAutoBotRunning}
                              className="rounded-full bg-black px-4 py-2 text-xs font-bold text-white outline-none"
                            >
                        ...
                        <div className="flex items-center justify-between gap-3 bg-[#e8e8e8] px-3 py-2.5 text-sm text-[#454545]">
                          <span>Restart buy/sell on error</span>
                          <button
                            type="button"
                            onClick={() => setBuilderRestartOnError((v) => !v)}
                            className={`h-6 w-11 rounded-full p-1 ${builderRestartOnError ? 'bg-emerald-500' : 'bg-black'}`}
                          >
                            <span className={`block h-4 w-4 rounded-full bg-white transition ${builderRestartOnError ? 'translate-x-5' : ''}`} />
                          </button>
                        </div>

                        <div className="flex items-center justify-between gap-3 bg-[#e8e8e8] px-3 py-2.5 text-sm text-[#454545]">
                          <span>Restart last trade on error</span>
                          <button
                            type="button"
                            onClick={() => setBuilderRestartLastTrade((v) => !v)}
                            className={`h-6 w-11 rounded-full p-1 ${builderRestartLastTrade ? 'bg-emerald-500' : 'bg-black'}`}
                          >
                            <span className={`block h-4 w-4 rounded-full bg-white transition ${builderRestartLastTrade ? 'translate-x-5' : ''}`} />
                          </button>
                        </div>

                        <div className="px-2 pt-3 text-lg font-medium">Run once at start:</div>

                        <div className="mt-2 bg-[#e8e8e8] px-3 py-3 text-[#454545]">
                          <div className="flex flex-wrap items-center gap-3">
                            <span className="text-sm">Trade options:</span>
                            <span className="rounded-full bg-black px-3 py-2 text-xs font-bold text-white">Ticks</span>
                            <input
                              value={duration}
                              onChange={(event) => setDuration(event.target.value)}
                              inputMode="numeric"
                              className="w-14 rounded-full bg-black px-3 py-2 text-center text-xs font-bold text-white outline-none"
                            />
                            ...
                            <input
                              ...
                              inputMode="decimal"
                              className="w-16 rounded-full bg-black px-3 py-2 text-center text-xs font-bold text-white outline-none"
                            />
                          </div>
                        </div>
                      </div>
                    ...
                    <section className="mt-28 overflow-hidden bg-[#075ac1] shadow-xl">
                      <div className="px-4 py-3 text-lg sm:text-xl font-medium">
                        2. Purchase conditions
                      </div>

                      <div className="grid gap-1 px-3 pb-4 sm:grid-cols-2">
                        <label className="bg-[#e8e8e8] px-3 py-3 text-[#454545]">
                          <span className="text-xs">Minimum confidence</span>
                          <input
                            value={minimumConfidence}
                            onChange={(event) => setMinimumConfidence(event.target.value)}
                            inputMode="decimal"
                            className="mt-2 w-full rounded-full bg-black px-4 py-2 text-sm font-black text-white outline-none"
                          />
                        </label>

                        <label className="bg-[#e8e8e8] px-3 py-3 text-[#454545]">
                          <span className="text-xs">Maximum trades</span>
                          <input
                            value={maxTrades}
                    ...
                    <div className="mt-5 rounded border border-[#17335c] bg-[#0b1015] p-3 text-xs text-slate-400">
                      {contractsStatus === 'ready'
                        ? `${uniqueBuilderContracts.length} Deriv contract${uniqueBuilderContracts.length === 1 ? '' : 's'} available for ${currentMarket?.underlying_symbol_name || symbol}.`
                        : 'Loading Deriv contract metadata…'}
                    </div>
                  </div>
                </main>
              </div>

              <div className="sticky bottom-0 z-30 border-t border-[#17335c] bg-[#071a33] p-3">
                <div className="mx-auto flex max-w-[760px] overflow-hidden border border-[#23518a]">
                  <button
                    type="button"
                    onClick={isAutoBotRunning ? () => stopAutoBot('Stopped by user.') : startAutoBot}
                    disabled={
                      !isAutoBotRunning &&
                      (!isAuthorized ||
                        !isTradingConnected ||
                    ...
                    className={`flex min-w-[170px] items-center justify-center gap-2 px-6 py-4 text-lg font-black disabled:opacity-40 ${
                      isAutoBotRunning ? 'bg-rose-500' : 'bg-[#08b6ad]'
                    }`}
                  >
                  ...
                  <div className="flex flex-1 items-center justify-between bg-[#20251f] px-4">
                    <div>
                      <p className="text-base font-black">NORMAL SPEED</p>
                      <p className="text-[9px] text-slate-500">Deriv demo execution</p>
                    </div>
                    <span className={`h-6 w-11 rounded-full border p-1 ${isAutoBotRunning ? 'border-emerald-400 bg-emerald-500/20' : 'border-slate-600 bg-[#0b1220]'}`}>
                      <span className={`block h-4 w-4 rounded-full ${isAutoBotRunning ? 'translate-x-5 bg-emerald-400' : 'bg-amber-400'}`} />
                    </span>
                  </div>
                </div>
              </div>
        ...
        {activeTab ===
          'manual' && (
          <div className="-mx-3 sm:-mx-5 lg:-mx-6 -mt-3 sm:-mt-5">
            <div className="min-h-[calc(100vh-120px)] bg-[#070808] text-white">
              <div className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-[#17335c] bg-[#071b38] px-4">
                <div className="flex items-center gap-3">
                  <button
                    type="button"
                ...
                <button
                  ...
                  className="flex items-center gap-3"
                >
                  <span className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-200 text-lg font-black text-slate-700">Đ</span>
                  <p className="text-lg font-black text-[#09b6ad]">
                    {balance !== null ? Number(balance).toFixed(2) : '—'} {currency}
                  </p>
                  <span className="text-2xl text-slate-200">⌄</span>
              ...
              <div className="px-4 py-4">
                <div className="max-w-[610px] border border-[#171c22] bg-[#151a22] px-4 py-4">
                  <div className="flex items-center gap-3">
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center bg-[#0a0d12] text-2xl">📊</div>
                    <div className="min-w-0 flex-1">
                      <select
                        value={symbol}
                        onChange={(event) => {
                        ...
                        disabled={isContractOpen || pendingBuyStatus.blocking}
                        className="w-full appearance-none bg-transparent pr-8 text-xl sm:text-2xl font-black outline-none"
                      >
                        {Object.entries(groupedMarkets).map(([group, items]) => (
                          <optgroup key={group} label={group}>
                            {items.map((item) => (
                              <option key={item.underlying_symbol} value={item.underlying_symbol} className="bg-slate-900">
                                {item.underlying_symbol_name}
                              </option>
                            ))}
                          </optgroup>
                      ...
                      <div className="mt-1 flex items-center gap-2 text-sm text-slate-400">
                        ...
                        <span>{isMarketConnected ? 'Live' : 'Reconnecting'}</span>
                      </div>
                    </div>
                ...
                <div className="relative mx-auto mt-12 min-h-[500px] max-w-[760px]">
                  <div className="grid grid-cols-5 gap-x-4 gap-y-8 sm:gap-x-8 sm:gap-y-10">
                    {analysis.percentages.map((item) => {
                      const hottest = analysis.mostFrequent?.digit === item.digit;
                      const coldest = analysis.leastFrequent?.digit === item.digit;
                      const current = Number(lastDigit) === item.digit;

                      return (
                        <div key={item.digit} className="relative flex flex-col items-center">
                          <div
                            className={`relative flex aspect-square w-full max-w-[86px] items-center justify-center rounded-full border-[8px] bg-[#060708] ${
                              hottest
                                ? 'border-[#18b8b0]'
                                : coldest
                                ? 'border-[#d72f46]'
                          ...
                          >
                            <div className="text-center leading-none">
                              <p className="text-xl sm:text-3xl font-black">{item.digit}</p>
                              <p className="mt-2 text-[11px] sm:text-sm text-slate-300">{item.percentage}%</p>
                            </div>
                          </div>
                          {current && <div className="absolute -bottom-7 text-2xl text-[#ff6e4b]">▲</div>}
                        </div>
                      );
                    })}
                  </div>
                  ...
                  <button
                    ...
                    className="absolute bottom-5 left-0 text-5xl font-light text-slate-700"
                  >
                    ≪
                  </button>
                  <button
                    type="button"
                    onClick={() => moveManualTradeType(1)}
                    className="absolute bottom-5 right-0 text-5xl font-light text-slate-300"
                  >
                    ≫
                  </button>
                </div>

                <div className="mx-auto max-w-[800px] bg-[#101212] p-4">
                  <p className="mb-4 text-sm text-slate-300 underline decoration-dotted underline-offset-4">
                  ...
                  <button
                    type="button"
                    onClick={() => moveManualTradeType(1)}
                    className="flex w-full items-center gap-3 bg-[#080909] px-4 py-4 text-left"
                  >
                    <span className="flex h-10 w-12 items-center justify-center text-2xl">
                      <span className="text-[#16b8b0]">{selectedManualTradeType.left.icon}</span>
                      <span className="text-[#d72f46]">{selectedManualTradeType.right.icon}</span>
                    </span>
                    <span className="text-xl font-black">{selectedManualTradeType.label}</span>
                    <span className="ml-auto text-3xl text-slate-300">›</span>
                  </button>

                  {selectedManualTradeType.needsBarrier && (
                    <div className="mt-3 bg-[#080909] p-3">
                      ...
                      <div className="grid grid-cols-10 gap-1.5">
                        {Array.from({ length: 10 }, (_, digit) => digit).map((digit) => (
                          <button
                            ...
                            className={`aspect-square border text-xs font-black ${
                              Number(manualBarrierDigit) === digit
                                ? 'border-[#ffb632] bg-[#ffb632] text-black'
                                : 'border-slate-800 bg-[#111] text-slate-300'
                            }`}
                          >
                            {digit}
                          </button>
                  ...
                  <div className="mt-3 grid grid-cols-2 bg-[#080909]">
                    <label className="px-4 py-3">
                      <span className="text-[10px] uppercase tracking-wider text-slate-600">Duration</span>
                      <div className="mt-1 flex items-center gap-2">
                        ...
                        />
                        <span className="text-sm text-slate-300">ticks</span>
                      </div>
                    </label>

                    <label className="border-l border-slate-800 px-4 py-3">
                      <span className="text-[10px] uppercase tracking-wider text-slate-600">Stake</span>
                      <div className="mt-1 flex items-center gap-2">
                        <input
                          value={baseStake}
                          onChange={(event) => {
                  ...
                  {manualQuoteError && (
                    <div className="mt-3 border border-amber-500/20 bg-amber-500/10 p-3 text-xs text-amber-300">
                      {manualQuoteError}
                    </div>
                  )}

                  {buyError && (
                    <div className="mt-3 border border-rose-500/20 bg-rose-500/10 p-3 text-xs text-rose-300">
                      {buyError}
                    </div>
                  )}
                  ...
                  <div className="mt-3 grid grid-cols-2 gap-3">
                    {[
                      ['left', selectedManualTradeType.left, manualQuotes.left, 'left'],
                      ['right', selectedManualTradeType.right, manualQuotes.right, 'right'],
                      ...
                      return (
                        <button
                          ...
                          className={`overflow-hidden border text-left disabled:opacity-45 ${
                            tone === 'left'
                              ? 'border-[#159c96] bg-[#337f7b]'
                              : 'border-[#ae3440] bg-[#8f3038]'
                          }`}
                        >
                          <div className={`flex min-h-20 items-center justify-center gap-3 px-3 py-4 ${
                            tone === 'left' ? 'bg-[#4da8a2]' : 'bg-[#c33b46]'
                          }`}>
                            <span className="text-2xl font-black">{contract.icon}</span>
                            <span className="text-xl sm:text-2xl font-black">{contract.label}</span>
                          </div>
                          <div className="flex items-center justify-between px-3 py-4">
                            <span className="text-sm text-white/80">Payout</span>
                  ...
                  <div className="mt-3 flex justify-end">
                    <button
                      ...
                      disabled={manualQuoteLoading || !isTradingConnected || isContractOpen || pendingBuyStatus.blocking}
                      className="border border-slate-800 bg-[#090c10] px-3 py-2 text-[10px] font-black text-slate-400 disabled:opacity-40"
                    >
                      REFRESH PAYOUTS
                    </button>
                  </div>
                  ...
                  {!isDemoAccount && (
                    <p className="mt-3 text-center text-[10px] font-black text-rose-300">
                      REAL-MONEY PURCHASES ARE BLOCKED
                    </p>
                  )}
                </div>
