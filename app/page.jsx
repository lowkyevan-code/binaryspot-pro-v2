      ...
      <div className="max-w-[1600px] mx-auto lg:flex lg:min-h-[calc(100vh-132px)]">
        ...
        {activeTab ===
          ...
          <div className="-mx-3 sm:-mx-5 lg:-mx-6">
            <div className="overflow-hidden border-y border-[#15386d] bg-[#05090e] shadow-2xl">
              <div className="grid grid-cols-3 border-b border-[#234b85] bg-[#0b2f66]">
                <button
                  type="button"
              ...
              <div className="relative min-h-[760px] bg-[#05080b]">
                <div className="absolute inset-y-0 left-0 z-10 w-14 border-r border-[#16365f] bg-[#071b35]">
                  <div className="flex h-full flex-col items-center gap-6 pt-6 text-2xl text-slate-200">
                    <span>↻</span>
                    <span>▱</span>
                    <span>☷</span>
                    <span className="h-px w-8 bg-[#1d4b7a]" />
                    <span>↶</span>
                    <span>↻</span>
                    <span className="h-px w-8 bg-[#1d4b7a]" />
                    <span>⌕</span>
                ...
                <div className="pl-16 pr-3 pt-4 sm:pl-20 sm:pr-5 sm:pt-6">
                  <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
                  <button
                    type="button"
                    className="bg-[#0759bc] px-6 py-4 text-xl sm:text-2xl font-black text-white shadow-lg"
                  >
                    Quick strategy
                  </button>
                ...
                <div className="max-w-[760px] space-y-5">
                  <section className="overflow-hidden rounded-xl border border-[#1463bc] bg-[#0757b9] shadow-xl">
                    ...
                    <div className="space-y-2 bg-[#0757b9] px-3 pb-4">
                      <div className="bg-[#e9e9e9] px-3 py-2.5 text-[#444] shadow-[0_1px_0_rgba(255,255,255,0.35)_inset]">
                ...
                <div className="sticky bottom-0 z-20 mt-8 border-t border-[#15386d] bg-[#071a34]/95 px-4 py-3 backdrop-blur">
        ...
        {activeTab ===
          'manual' && (
          <div className="-mx-3 sm:-mx-5 lg:-mx-6">
            <div className="overflow-hidden border-y border-slate-800 bg-[#07090c] shadow-2xl">
              <div className="grid grid-cols-3 border-b border-[#224a83] bg-[#0b2f66]">
                <button
                  type="button"
                  onClick={() =>
                    setActiveTab(
              ...
              <div className="px-4 py-3 sm:px-5">
                <div className="w-full max-w-[610px] border border-[#171c22] bg-[#151a22] p-4">
                  <div className="flex items-center gap-3">
                ...
                <div className="relative mt-10 min-h-[360px] sm:min-h-[430px]">
                  <div className="mx-auto grid max-w-[720px] grid-cols-5 gap-x-4 gap-y-8 px-3 sm:gap-x-7 sm:gap-y-10">
                ...
                <div className="border border-[#14191e] bg-[#101315] p-4">
                  <button
                    type="button"
                    onClick={() => moveManualTradeType(1)}
